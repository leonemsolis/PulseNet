...
{
    [JsonProperty("BeginVolume")]
    public ScalarVolumeData BeginVolume { get; set; }

    [JsonProperty("EndVolume")]
    public ScalarVolumeData EndVolume { get; set; }

    [JsonProperty("Compliance")]
    public ScalarVolumePerPressureData Compliance { get; set; }
}
...
public class SegmentLinearData
{
    ...
    [JsonProperty("Slope")]
    public ScalarPressurePerVolumeData Slope { get; set; }

    [JsonProperty("YIntercept")]
    public ScalarPressureData YIntercept { get; set; }
}
...
public class SegmentParabolicData
{
    ...
    public ScalarData Coefficient1 { get; set; }

    [JsonProperty("Coefficient2")]
    public ScalarData Coefficient2 { get; set; }

    [JsonProperty("Coefficient3")]
    public ScalarData Coefficient3 { get; set; }

    [JsonProperty("Coefficient4")]
    public ScalarData Coefficient4 { get; set; }
}
...
public class SegmentSigmoidalData
{
    ...
    public ScalarPressureData LowerCorner { get; set; }

    [JsonProperty("UpperCorner")]
    public ScalarPressureData UpperCorner { get; set; }

    [JsonProperty("BaselineCompliance")]
    public ScalarVolumePerPressureData BaselineCompliance { get; set; }
}
...
public class CurveData
{
    ...
    public List<AnySegmentData> Segment { get; set; }
}
...
public class TemporalInterpolatorData
{
    ...
    [JsonProperty("PositiveTransition")]
    public bool PositiveTransition { get; set; }
...
public class Scalar0To1Data
{
    ...
    public ScalarData Scalar0To1 { get; set; }
}

public class ScalarNegative1To1Data
{
    [JsonProperty("ScalarNegative1To1")]
    public ScalarData ScalarNegative1To1 { get; set; }
}

public class ScalarAmountData
{
    [JsonProperty("ScalarAmount")]
    public ScalarData ScalarAmount { get; set; }
}

public class ScalarAmountPerMassData
{
    [JsonProperty("ScalarAmountPerMass")]
    public ScalarData ScalarAmountPerMass { get; set; }
}

public class ScalarAmountPerTimeData
{
    [JsonProperty("ScalarAmountPerTime")]
    public ScalarData ScalarAmountPerTime { get; set; }
}
...
public class ScalarAreaData
{
    ...
    public ScalarData ScalarArea { get; set; }
}
...
{
    [JsonProperty("ScalarElectricCharge")]
    public ScalarData ScalarElectricCharge { get; set; }
}
...
public class ScalarEnergyData
{
    ...
    public ScalarData ScalarEnergy { get; set; }
}
...
public class ScalarEnergyPerMassData
{
    ...
    public ScalarData ScalarEnergyPerMass { get; set; }
}
...
{
    [JsonProperty("ScalarForce")]
    public ScalarData ScalarForce { get; set; }
}

public class ScalarFrequencyData
{
    [JsonProperty("ScalarFrequency")]
    public ScalarData ScalarFrequency { get; set; }
}
...
{
    [JsonProperty("ScalarHeatInductance")]
    public ScalarData ScalarHeatInductance { get; set; }
}

public class ScalarHeatResistanceData
{
    [JsonProperty("ScalarHeatResistance")]
    public ScalarData ScalarHeatResistance { get; set; }
}
...
public class ScalarInverseVolumeData
{
    ...
    public ScalarData ScalarInverseVolume { get; set; }
}

public class ScalarLengthData
{
    [JsonProperty("ScalarLength")]
    public ScalarData ScalarLength { get; set; }
}

public class ScalarLengthPerTimeData
{
    [JsonProperty("ScalarLengthPerTime")]
    public ScalarData ScalarLengthPerTime { get; set; }
}
...
public class ScalarMassData
{
    ...
    public ScalarData ScalarMass { get; set; }
}

public class ScalarMassPerAmountData
{
    [JsonProperty("ScalarMassPerAmount")]
    public ScalarData ScalarMassPerAmount { get; set; }
}
...
public class ScalarPressureData
{
    ...
    public ScalarData ScalarPressure { get; set; }
}
...
{
    [JsonProperty("Value")]
    public DoubleArrayData Value { get; set; }
...
{
    [JsonProperty("ArrayTime")]
    public ArrayData ArrayTime { get; set; }
}

public class FunctionData
{
    [JsonProperty("Dependent")]
    public DoubleArrayData Dependent { get; set; }

    [JsonProperty("Independent")]
    public DoubleArrayData Independent { get; set; }

    [JsonProperty("DependentUnit")]
    public string DependentUnit { get; set; }

    [JsonProperty("IndependentUnit")]
    public string IndependentUnit { get; set; }
}

public class FunctionVolumeVsTimeData
{
    [JsonProperty("FunctionVolumeVsTime")]
    public FunctionData FunctionVolumeVsTime { get; set; }
}
...
public class HistogramData
{
    ...
    public FunctionData Histogram { get; set; }
}
